...
Source: https://devdocs.io/go/log/slog/index
...
attr.go doc.go handler.go json_handler.go level.go logger.go multi_handler.go record.go text_handler.go value.go
...
### func (*MultiHandler) Enabled 1.26

```
func (h *MultiHandler) Enabled(ctx context.Context, l Level) bool
```

### func (*MultiHandler) Handle 1.26

```
func (h *MultiHandler) Handle(ctx context.Context, r Record) error
```

### func (*MultiHandler) WithAttrs 1.26

```
func (h *MultiHandler) WithAttrs(attrs []Attr) Handler
```

### func (*MultiHandler) WithGroup 1.26
