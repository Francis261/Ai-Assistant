...
Source: https://devdocs.io/go/reflect/index
...
abi.go badlinkname.go deepequal.go float32reg_generic.go iter.go makefunc.go map.go swapper.go type.go value.go visiblefields.go
...
### func (StructField) IsExported 1.17
