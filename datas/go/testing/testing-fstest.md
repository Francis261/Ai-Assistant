...
Source: https://devdocs.io/go/testing/fstest/index
...
### func (MapFS) Glob 1.16

```
func (fsys MapFS) Glob(pattern string) ([]string, error)
```

### func (MapFS) Lstat 1.25
...
### func (MapFS) ReadDir 1.16

```
func (fsys MapFS) ReadDir(name string) ([]fs.DirEntry, error)
```

### func (MapFS) ReadFile 1.16

```
func (fsys MapFS) ReadFile(name string) ([]byte, error)
```

### func (MapFS) ReadLink 1.25
...
© Google, Inc.Licensed under the Creative Commons Attribution License 3.0.
 http://golang.org/pkg/testing/fstest/
