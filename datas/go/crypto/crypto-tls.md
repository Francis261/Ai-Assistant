...
Source: https://devdocs.io/go/crypto/tls/index
...
alert.go auth.go cache.go cipher_suites.go common.go common_string.go conn.go defaults.go defaults_fips140.go ech.go handshake_client.go handshake_client_tls13.go handshake_messages.go handshake_server.go handshake_server_tls13.go key_agreement.go key_schedule.go prf.go quic.go ticket.go tls.go
...
type ClientHelloInfo struct {
    ...
    HelloRetryRequest bool // Go 1.26
    // contains filtered or unexported fields
}
```
...
### func (*ClientSessionState) ResumptionState 1.21
...
type Config struct {
    ...
    EncryptedClientHelloConfigList []byte // Go 1.23
    ...
    EncryptedClientHelloRejectionVerify func(ConnectionState) error // Go 1.23
    ...
    GetEncryptedClientHelloKeys func(*ClientHelloInfo) ([]EncryptedClientHelloKey, error) // Go 1.25
    ...
    EncryptedClientHelloKeys []EncryptedClientHelloKey // Go 1.24
    // contains filtered or unexported fields
}
```
...
### func (*Config) DecryptTicket 1.21
...
### func (*Config) EncryptTicket 1.21
...
### func (*ECHRejectionError) Error 1.23

```
func (e *ECHRejectionError) Error() string
```

## type EncryptedClientHelloKey 1.24
...
type QUICConfig struct {
    ...
    EnableSessionEvents bool // Go 1.23
}
```
...
### func (*QUICConn) ConnectionState 1.21
...
### func (*QUICConn) SendSessionTicket 1.21
...
### func (*QUICConn) SetTransportParameters 1.21
...
### func (*QUICConn) StoreSession 1.23
...
### func (QUICEncryptionLevel) String 1.21
...
type QUICEvent struct {
    ...
    SessionState *SessionState // Go 1.23
...
## type QUICSessionTicketOptions 1.21
