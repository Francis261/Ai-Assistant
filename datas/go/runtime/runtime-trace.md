...
Source: https://devdocs.io/go/runtime/trace/index
...
annotation.go batch.go encoding.go flightrecorder.go recorder.go subscribe.go trace.go
...
### func (*FlightRecorder) Enabled 1.25
...
### func (*FlightRecorder) Start 1.25
...
### func (*FlightRecorder) WriteTo 1.25
...
## type FlightRecorderConfig 1.25
...
© Google, Inc.Licensed under the Creative Commons Attribution License 3.0.
 http://golang.org/pkg/runtime/trace/
