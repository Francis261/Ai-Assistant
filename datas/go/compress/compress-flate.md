...
Source: https://devdocs.io/go/compress/flate/index
...
Package flate implements the DEFLATE compressed data format, described in RFC 1951. The compress/gzip and compress/zlib packages implement access to DEFLATE-based file formats.
