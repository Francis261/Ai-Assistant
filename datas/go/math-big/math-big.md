...
Source: https://devdocs.io/go/math/big/index
...
accuracy_string.go arith.go arith_amd64.go arith_decl.go decimal.go doc.go float.go floatconv.go floatmarsh.go ftoa.go int.go intconv.go intmarsh.go nat.go natconv.go natdiv.go natmul.go prime.go rat.go ratconv.go ratmarsh.go roundingmode_string.go sqrt.go
...
(See Daan Leijen, “Division and Modulus for Computer Scientists”.) See Int.DivMod for Euclidean division and modulus (unlike Go).
