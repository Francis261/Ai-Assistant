...
Source: https://devdocs.io/vite/releases
...
- Important fixes and security patches are backported to vite@6.4 and vite@7.2.
- Security patches are also backported to vite@5.4 and vite@7.1.
