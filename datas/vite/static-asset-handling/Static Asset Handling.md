...
Source: https://devdocs.io/vite/guide/assets
...
```
import  from 'extra-scalloped-border/worklet.js?url'
...
```
import  from './img.svg?no-inline'
import  from './img.png?inline'
```
...
import  from './shader.js?worker'
const  = new ()
```

```
// sharedworker
import  from './shader.js?sharedworker'
const  = new ()
```

```
// Inlined as base64 strings
import  from './shader.js?worker&inline'
```
