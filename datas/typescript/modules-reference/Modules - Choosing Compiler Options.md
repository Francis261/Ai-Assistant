...
Source: https://devdocs.io/typescript/docs/handbook/modules/guides/choosing-compiler-options
...
- strict: true. Without this, you may write type-level code that ends up in your output .d.ts files and errors when a consumer compiles with strict enabled. For example, this extends clause: export interface Super {
 foo: string;
}
