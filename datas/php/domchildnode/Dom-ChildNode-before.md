...
Source: https://devdocs.io/php/dom-childnode.before
...
```
public Dom\ChildNode::before(Dom\Node|string ...$nodes): void
```
...
© 1997–2025 The PHP Documentation GroupLicensed under the Creative Commons Attribution License v3.0 or later.
 https://www.php.net/manual/en/dom-childnode.before.php
