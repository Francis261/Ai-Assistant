...
Source: https://devdocs.io/php/function.grapheme-stristr
...
If true, grapheme_stristr() returns the part of the haystack before the first occurrence of the needle (excluding needle).
