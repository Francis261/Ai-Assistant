...
Source: https://devdocs.io/php/language.operators.bitwise
...
Another way to accomplish that is using XOR (^) to find bits that are on in only one value or the other: E_ALL ^
 E_NOTICE
