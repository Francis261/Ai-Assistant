...
Source: https://devdocs.io/php/language.types.string
...
The most important feature of double-quoted strings is the fact that variable names will be expanded. See string interpolation for details.
