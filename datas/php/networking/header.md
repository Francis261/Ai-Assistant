...
Source: https://devdocs.io/php/function.header
...
setcookie() provides a convenient way to set cookies. To set a cookie that includes attributes which setcookie() doesn't support, header() can be used.
