...
Source: https://devdocs.io/php/function.fopen
...
The optional third use_include_path parameter can be set to true if you want to search for the file in the include_path, too.
