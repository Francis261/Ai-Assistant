...
Source: https://devdocs.io/vite~6/guide/backend-integration
...

{
 ...
 "css": ["assets/foo-5UjPuW-k.css"]
  ...
  - For the CSS file generated when build.cssCodeSplit is false, the key is style.css.
...
Pseudo implementation of importedChunksAn example pseudo implementation of importedChunks in TypeScript (This will need to be adapted for your programming language and templating language):
...
© 2019–present, Yuxi (Evan) You and Vite contributorsLicensed under the MIT License.
 https://v6.vite.dev/guide/backend-integration
