...
Source: https://devdocs.io/vite~6/config/server-options#server-sourcemapignorelist
...
Note that this downgrades to TLS only when the server.proxy option is also used.
...
© 2019–present, Yuxi (Evan) You and Vite contributorsLicensed under the MIT License.
 https://v6.vite.dev/config/server-options
