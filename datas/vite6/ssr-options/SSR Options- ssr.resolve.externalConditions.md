...
Source: https://devdocs.io/vite~6/config/ssr-options#ssr-resolve-externalconditions
...
When using this option, make sure to run Node with --conditions flag with the same values in both dev and build to get a consistent behavior.
...
© 2019–present, Yuxi (Evan) You and Vite contributorsLicensed under the MIT License.
 https://v6.vite.dev/config/ssr-options
