...
Source: https://devdocs.io/vite~6/guide/api-hmr#hot-invalidate-message-string
...
See Client-server Communication for more details, including a section on Typing Custom Events.
...
© 2019–present, Yuxi (Evan) You and Vite contributorsLicensed under the MIT License.
 https://v6.vite.dev/guide/api-hmr
