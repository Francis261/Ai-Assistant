...
Source: https://devdocs.io/vite~6/guide/troubleshooting#outdated-pre-bundled-deps-when-linking-to-a-local-package
...
If these codes are used inside dependencies, you could use patch-package (or yarn patch or pnpm patch) for an escape hatch.
...
© 2019–present, Yuxi (Evan) You and Vite contributorsLicensed under the MIT License.
 https://v6.vite.dev/guide/troubleshooting
