...
Source: https://devdocs.io/vite~6/guide/performance#warm-up-frequently-used-files
...
- Use Rolldown instead of Rollup and esbuild for faster builds and a more aligned experience between dev and build.
...
© 2019–present, Yuxi (Evan) You and Vite contributorsLicensed under the MIT License.
 https://v6.vite.dev/guide/performance
