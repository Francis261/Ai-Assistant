...
Source: https://devdocs.io/vite~6/guide/api-environment-plugins#accessing-the-current-environment-in-hooks
...
© 2019–present, Yuxi (Evan) You and Vite contributorsLicensed under the MIT License.
 https://v6.vite.dev/guide/api-environment-plugins
