...
Source: https://devdocs.io/vite~6/guide/features#npm-dependency-resolving-and-pre-bundling
...
Note that if compilerOptions.types is specified, only these packages will be included in the global scope (instead of all visible ”@types” packages).
...
© 2019–present, Yuxi (Evan) You and Vite contributorsLicensed under the MIT License.
 https://v6.vite.dev/guide/features
