...
Source: https://devdocs.io/vite~6/guide/api-environment-frameworks#default-runnabledevenvironment
...
Frameworks that communicate with their runtime via the Fetch API can utilize the FetchableDevEnvironment that provides a standardized way of handling requests via the handleRequest method:
...
© 2019–present, Yuxi (Evan) You and Vite contributorsLicensed under the MIT License.
 https://v6.vite.dev/guide/api-environment-frameworks
