...
Source: https://devdocs.io/react/reference/react-dom/components/common
...
- e: A React event object with these extra DragEvent properties: It also includes the inherited MouseEvent properties: It also includes the inherited UIEvent properties:
  - dataTransfer
  - altKey
  - button
  - buttons
...
- e: A React event object with these extra FocusEvent properties: It also includes the inherited UIEvent properties:
  - relatedTarget
  - detail
  - view
...
- e: A React event object with these extra KeyboardEvent properties: It also includes the inherited UIEvent properties:
  - altKey
  - charCode
  - code
  - ctrlKey
...
- e: A React event object with these extra MouseEvent properties: It also includes the inherited UIEvent properties:
  - altKey
  - button
  - buttons
  - ctrlKey
...
- e: A React event object with these extra PointerEvent properties: It also includes the inherited MouseEvent properties: It also includes the inherited UIEvent properties:
  - height
  - isPrimary
  - pointerId
  - pointerType
...
- e: A React event object with these extra TouchEvent properties: It also includes the inherited UIEvent properties:
  - altKey
  - ctrlKey
  - changedTouches
  - getModifierState(key)
...
- e: A React event object with these extra WheelEvent properties: It also includes the inherited MouseEvent properties: It also includes the inherited UIEvent properties:
  - deltaMode
  - deltaX
  - deltaY
  - deltaZ
