...
Source: https://devdocs.io/html/reference/elements/script/type/speculationrules
...
2. However, if the document is located at https://example.com/some/subpage.html and the rules are at https://other.example/resources/rules.json (for example, on a third-party or cookieless resource origin), then: This is the typical use case for "relative_to".
...
If the document is located at https://example.com/some/subpage.html and the rules are at https://example.com/resources/rules.json, then /home always equates to https://example.com/home regardless of whether relative_to is set to document or ruleset.

However, if the document is located at https://example.com/some/subpage.html and the rules are at https://other.example/resources/rules.json (for example, on a third-party or cookieless resource origin), then:
...
Another potential (but rarer) use case is when your URLs are specified in the form home instead of /home. If the document is located at https://example.com/some/subpage.html and the rules are at https://example.com/resources/rules.json, then:
