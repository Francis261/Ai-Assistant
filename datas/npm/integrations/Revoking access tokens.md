...
Source: https://devdocs.io/npm/revoking-access-tokens
...
1. To see a list of your tokens, on the command line, run: npm token list
2. In the tokens table, find and copy the ID of the token you want to delete.
3. On the command line, run the following command, replacing 123456 with the ID of the token you want to delete: npm token delete 123456 npm will report Removed 1 token
