...
Source: https://devdocs.io/npm/creating-a-package-json-file
...
2. To add custom questions, using a text editor, add questions with the prompt function: module.exports = prompt("what's your favorite flavor of ice cream, buddy?", "I LIKE THEM ALL");
