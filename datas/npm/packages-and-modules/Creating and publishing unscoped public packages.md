...
Source: https://devdocs.io/npm/creating-and-publishing-unscoped-public-packages
...
1. On the command line, create a directory for your package: mkdir my-test-package
2. Navigate to the root directory of your package: cd my-test-package
...
2. To publish your public package to the npm registry, run: npm publish Note: If you use GitHub Actions to publish your packages, you can generate provenance information for each package you publish. For more information, see "Generating provenance statements."
