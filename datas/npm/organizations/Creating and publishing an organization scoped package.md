...
Source: https://devdocs.io/npm/creating-and-publishing-an-organization-scoped-package
...
1. On the command line, make a directory with the name of the package you would like to create. mkdir /path/to/package/directory
2. Navigate to the newly-created package directory.
3. To create an organization scoped package, on the command line, run: npm init --scope=<your_org_name>
