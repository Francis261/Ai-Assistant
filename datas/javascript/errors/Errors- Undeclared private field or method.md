...
Source: https://devdocs.io/javascript/errors/undeclared_private_field_or_method
...
These code are probably mistakes because it's impossible for #x to exist on this if it's not declared in the class scope. Note that you cannot dynamically add private elements to unrelated objects. You should either remove this code or declare the private field in the class scope.
...
© 2005–2025 MDN contributors.Licensed under the Creative Commons Attribution-ShareAlike License v2.5 or later.
 https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Errors/Undeclared_private_field_or_method
