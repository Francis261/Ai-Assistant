...
Source: https://devdocs.io/javascript/global_objects/map/getorinsert
...
- Polyfill of Map.prototype.getOrInsert in core-js
- es-shims polyfill of Map.prototype.getOrInsert
- Map
- Map.prototype.get()
- Map.prototype.set()
- Map.prototype.has()
