...
Source: https://devdocs.io/javascript/global_objects/intl/locale/maximize
...
An Intl.Locale instance whose baseName property returns the result of the Add Likely Subtags algorithm executed against locale.baseName.
