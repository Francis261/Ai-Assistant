...
Source: https://devdocs.io/javascript/operators/new
...
1. Define the object type by writing a function that specifies its name and properties. For example, a constructor function to create an object Foo might look like this: function Foo(bar1, bar2) {
 this.bar1 = bar1;
 this.bar2 = bar2;
}
2. Create an instance of the object with new. const myFoo = new Foo("Bar 1", 2021);
