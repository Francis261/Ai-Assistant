...
Source: https://devdocs.io/javascript/operators/bitwise_and
...
Warning: You may see people using & -1 to truncate numbers to integers. Bitwise ANDing any number x with -1 returns x converted to a 32-bit integer, which additionally removes leading bits for numbers outside the range -2147483648 to 2147483647. Use Math.trunc() instead.
