...
Source: https://devdocs.io/javascript/operators/right_shift
...
Warning: You may see people using >> 0 to truncate numbers to integers. Right shifting any number x by 0 returns x converted to a 32-bit integer, which additionally removes leading bits for numbers outside the range -2147483648 to 2147483647. Use Math.trunc() instead.
