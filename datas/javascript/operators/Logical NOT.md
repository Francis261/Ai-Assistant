...
Source: https://devdocs.io/javascript/operators/logical_not
...
It is possible to use a couple of NOT operators in series to explicitly force the conversion of any value to the corresponding boolean primitive. The conversion is based on the "truthiness" or "falsiness" of the value (see truthy and falsy).
