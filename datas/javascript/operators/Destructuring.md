...
Source: https://devdocs.io/javascript/operators/destructuring
...
Without destructuring, swapping two values requires a temporary variable (or, in some low-level languages, the XOR-swap trick).
