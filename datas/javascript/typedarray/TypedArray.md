...
Source: https://devdocs.io/javascript/global_objects/typedarray
...
Returns false if it finds one element in the array that does not satisfy the provided testing function. Otherwise, it returns true. See also Array.prototype.every().
...
Returns true if it finds one element in the array that satisfies the provided testing function. Otherwise, it returns false. See also Array.prototype.some().
