...
Source: https://devdocs.io/javascript/global_objects/temporal/plaintime/from
...
- An object containing at least one of the following properties (in the order they are retrieved and validated): They are truncated to be integers. Out-of-range values are handled by the overflow option.
  - hour
  - microsecond
  - millisecond
  - minute
