...
Source: https://devdocs.io/http/status/308
...
- 301 Moved Permanently, the equivalent of this status code, but that may change the method used when it is not a GET.
